"""
collections.Counter Medium Example 10: Aggregation Pattern
Difficulty: Medium

Business Question:
Use collections.Counter to solve an aggregation/ranking business problem.

How to run:
    python medium_10_counter_aggregation_pattern.py
"""
