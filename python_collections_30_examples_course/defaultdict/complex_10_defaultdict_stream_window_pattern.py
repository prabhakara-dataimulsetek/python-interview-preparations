"""
collections.defaultdict Complex Example 10: Stream Window Pattern
Difficulty: Complex

Business Question:
Solve a stream/window analytics problem using collections.defaultdict concepts plus supporting collections.

How to run:
    python complex_10_defaultdict_stream_window_pattern.py
"""
