"""
dict Medium Example 10: Aggregation Pattern
Difficulty: Medium

Business Question:
Use dict to solve an aggregation/ranking business problem.

How to run:
    python medium_10_dictionaries_aggregation_pattern.py
"""
