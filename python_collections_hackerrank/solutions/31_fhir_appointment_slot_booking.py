"""
Problem 31: FHIR Appointment Slot Booking
Topic: mixed
Difficulty: Medium/Complex

Business question:
Given slots and booking requests, book earliest matching provider/specialty slot.

Core idea:
Use dict of heaps by specialty/provider and set for booked.
"""
