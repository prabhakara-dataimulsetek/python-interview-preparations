# Problem 4: K Closest Delivery Points

**Topic:** Python `lists` collections  
**Difficulty:** Medium to Complex

## Real Business Question
Given x,y points, return K closest to warehouse sorted by distance then coordinates.
...
Use sorting or heap; tests tuple/list ordering.
