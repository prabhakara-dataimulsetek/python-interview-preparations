# Problem 2: Inventory Rotation Queries

**Topic:** Python `lists` collections  
**Difficulty:** Medium to Complex

## Real Business Question
Apply many range rotation operations on product IDs, then answer index queries.
...
Use modulo arithmetic and avoid physically rotating every time.
